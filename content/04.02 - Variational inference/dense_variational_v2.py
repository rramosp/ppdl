...
class XDenseVariational(tf.keras.layers.Layer):
  ...
  def __init__(self,
    ...
    super(XDenseVariational, self).__init__(
  ...
  def call(self, inputs):
    print ("-- CALLED with inputs", inputs)
    dtype = tf.as_dtype(self.dtype or tf.keras.backend.floatx())
    ...
    print ("-- POSTERIOR params", q.parameters['loc'], q.parameters['scale'])
    print ("-- PRIOR     params", r.parameters['loc'], r.parameters['scale'])
