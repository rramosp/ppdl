...
def generate_stickman(size = 1.0, general_color = BLACK, color_head = BLACK,
    ...
    stickman_head = Circle(radius = 0.5, color= color_head,**kwargs)
    ...
    stickman_torso = Line(start=stickman_head.get_bottom(),end=ref_point_torso.get_center(),buff=0, color=color_torso,**kwargs)
    ...
    stickman_left_arm = Line(start=stickman_torso.get_center(), end = ref_point_left_arm, buff = 0, color = color_left_arm,**kwargs)
    stickman_right_arm = Line(start=stickman_torso.get_center(), end = ref_point_right_arm, buff = 0, color = color_right_arm,**kwargs)

    stickman_left_leg = Line(start=stickman_torso.get_end(), end=ref_point_left_leg, buff= 0, color= color_left_leg,**kwargs)
    stickman_right_leg = Line(start = stickman_torso.get_end(), end = ref_point_right_leg, buff = 0, color = color_right_leg,**kwargs)
